  ...
  @function randomNum($a, $b) {
	...
	* {
	...
	@for $i from 1 through 80 {
		$size: randomNum(4, 0) + 1px;

		.star:nth-child(#{$i}) {
			top: randomNum(100,0) + 0vh;
			left: randomNum(100,0) + 0vw;
